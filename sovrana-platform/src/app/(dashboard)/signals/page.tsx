...
import {
  Signal as SignalIcon, Check, X, Filter, ArrowUpRight, ArrowDownRight,
  CheckCircle, XCircle, Loader2, RefreshCw, Activity,
} from 'lucide-react';
...
export default function SignalsPage() {
  ...
  const fetchSignals = useCallback(async () => {
    try {
      const res = await fetch('/api/agents/state?limit=100');
      if (res.ok) {
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-end justify-between">
        ...
        <div className="flex items-center gap-3">
          <button onClick={fetchSignals} className="btn-secondary flex items-center gap-2 py-2 px-3.5">
      ...
      {loading && (
        <div className="flex items-center justify-center py-20">
          ...
          <span className="ml-3 text-slate-500">Loading signals...</span>
        </div>
      )}
      ...
      {!loading && signals.length === 0 && (
        <div className="card p-12 text-center">
          ...
          <p className="text-xs text-slate-400 mt-1">Go to the Agents page and click &ldquo;Run Agents Now&rdquo; to start generating signals</p>
        </div>
      )}
